...
tail.on("line", function (data) {
    ...
    if (/(^Labyrinth Event begins in .* (hour|minute(s|))\.$|^Labyrinth event is starting...$)/.test(data)) {
        ...
        sendMessage(channelRawAlerts, `${data} ||${pingLabyrinth}||`, false)
    ...
    if (data === "Snowmen invade /pvp!") {
        ...
        sendMessage(channelRawAlerts, `${data} ||${pingSnow}||`, false)
    ...
    if (/^Fox Hunt Event begins in (30|20|10|5|1) (hour|minute(s|)|seconds)\.$/.test(data)) {
        ...
        sendMessage(channelRawAlerts, `${data} ||${pingFox}||`, false)
    ...
    if (/^Battle for Minewind begins in (30|20|10|5|1) (hour|minute(s|)|seconds)\.$/.test(data)) {
        ...
        sendMessage(channelRawAlerts, `${data} ||${pingCastle}||`, false)
